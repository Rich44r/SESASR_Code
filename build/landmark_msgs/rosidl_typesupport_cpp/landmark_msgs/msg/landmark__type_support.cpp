...
static const _Landmark_type_support_symbol_names_t _Landmark_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, landmark_msgs, msg, Landmark)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, landmark_msgs, msg, Landmark)),
  }
};
...
{
  return &::landmark_msgs::msg::rosidl_typesupport_cpp::Landmark_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, landmark_msgs, msg, Landmark)() {
  return get_message_type_support_handle<landmark_msgs::msg::Landmark>();
}
