...
{
  new (message_memory) landmark_msgs::msg::LandmarkArray(_init);
}

void LandmarkArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<landmark_msgs::msg::LandmarkArray *>(message_memory);
  typed_message->~LandmarkArray();
}

size_t size_function__LandmarkArray__landmarks(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<landmark_msgs::msg::Landmark> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<landmark_msgs::msg::Landmark> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<landmark_msgs::msg::Landmark> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const landmark_msgs::msg::Landmark *>(
    get_const_function__LandmarkArray__landmarks(untyped_member, index));
  auto & value = *reinterpret_cast<landmark_msgs::msg::Landmark *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<landmark_msgs::msg::Landmark *>(
    get_function__LandmarkArray__landmarks(untyped_member, index));
  const auto & value = *reinterpret_cast<const landmark_msgs::msg::Landmark *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LandmarkArray_message_member_array[2] = {
  {
    ...
    offsetof(landmark_msgs::msg::LandmarkArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<landmark_msgs::msg::Landmark>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(landmark_msgs::msg::LandmarkArray, landmarks),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LandmarkArray_message_members = {
  "landmark_msgs::msg",  // message namespace
  "LandmarkArray",  // message name
  2,  // number of fields
  sizeof(landmark_msgs::msg::LandmarkArray),
...
{
  return &::landmark_msgs::msg::rosidl_typesupport_introspection_cpp::LandmarkArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, landmark_msgs, msg, LandmarkArray)() {
  return &::landmark_msgs::msg::rosidl_typesupport_introspection_cpp::LandmarkArray_message_type_support_handle;
}
